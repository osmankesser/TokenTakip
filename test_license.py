...
class LicenseGateTests(unittest.TestCase):
    ...
    def _lic(self, body: str = "TokenTakip test license body.\n") -> Path:
    ...
    def test_old_ver_prompts_again(self) -> None:
        path = self._lic()
    ...
    def test_accept_writes_only_license_ver(self) -> None:
        ...
        self.addCleanup(win.close)
        self.assertEqual(self._settings.value("license_accepted_ver"), LICENSE_DOC_VER)
        self.assertIsInstance(self._settings.value("license_accepted_ver"), str)
