...
TEXTS_FALLBACK_EN = {
    ...
    "agent_story_title": "Your history with {name}",
    "agent_story_first": "First seen: {date}",
    "agent_story_sessions": "Sessions scanned: {n}",
    ...
    "agent_story_empty": "No local session files found for this agent yet.",
    "agent_story_trunc": "Sample of recent sessions (not full lifetime).",
    "agents_title": "Agents",
    "agents_hint": "Tap a logo for that agent’s page: quota tips, history, rules and extensions.",
...
TEXTS: dict[str, dict[str, str]] = {
    "tr": _finish({
        ...
        "agent_story_title": "{name} ile geçmişin",
        "agent_story_first": "İlk görülme: {date}",
        "agent_story_sessions": "Taranan oturum: {n}",
        ...
        "agent_story_empty": "Bu ajan için henüz yerel oturum dosyası yok.",
        "agent_story_trunc": "Son oturumlardan örnek (tüm ömür değil).",
        "agents_title": "Ajanlar",
        "agents_hint": "Logoya bas — o ajanın sayfası: kota ipuçları, geçmiş, kurallar ve eklentiler.",
